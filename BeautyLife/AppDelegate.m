...
//  BeautyLife
//
//  Created by Xiedonghua on 16/3/16.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    CenterDrawerViewController *centerVC = [[CenterDrawerViewController alloc] init];
    ...
    drawerVC.view.backgroundColor = [UIColor yellowColor];
